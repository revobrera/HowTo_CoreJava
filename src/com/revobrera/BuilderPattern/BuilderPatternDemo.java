package com.revobrera.BuilderPattern;
...
/*	Builder pattern builds a complex object using simple objects 
	...
	a typical meal could be a burger and a cold drink. Burger could 
	be either a Veg Burger or Chicken Burger and will be packed by a 
	...
	We then create a Meal class having ArrayList of Item and a MealBuilder 
	to build different types of Meal objects by combining Item. 
